...
print("Graph - 1")
heu_values = {'A': 1, 'B': 6, 'C': 2, 'D': 12, 'E': 2, 'F': 1, 'G': 5,
              'H': 7, 'I': 7, 'J': 1}  # Heuristic values of Nodes
mygraph = {  # Graph of Nodes and Edges
    # Neighbors of Node 'A', B, C & D with repective weights
    'A': [[('B', 1), ('C', 1)], [('D', 1)]],
    'B': [[('G', 1)], [('H', 1)]],  # Neighbors are included in a list of lists
    'C': [[('J', 1)]],  # Each sublist indicate a "OR" node or "AND" nodes
    'D': [[('E', 1), ('F', 1)]],
    'G': [[('I', 1)]]
}

# Instantiate Graph object with graph, heuristic values and start Node
G1 = Graph(mygraph, heu_values, 'A')
